...
struct BORG_Problem_t {
	...
	double* epsilons;
	const char** names;
	void (*function)(double*, double*, double*,int,char**,int);
};
...
BORG_Problem BORG_Problem_create(
		...
		int numberOfObjectives,
		int numberOfConstraints,
		void (*function)(double*, double*, double*,int argc,char* argv[],int rank)) {
...
void BORG_Solution_evaluate(BORG_Solution solution,int argc,char* argv[]) {
	...
	solution->problem->function(solution->variables, solution->objectives, solution->constraints,argc,argv,-1);
